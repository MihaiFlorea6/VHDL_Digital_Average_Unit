...
This project developed a compact, two-component hardware system to efficiently calculate the arithmetic mean of a stream of 8-bit input data1. 
...
Key Technologies: VHDL, Digital Design, Hardware Synthesis, Moving Average Filter, LFSR.
